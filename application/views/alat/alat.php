<!DOCTYPE html>
  <html lang="en">
    ...
    <div class="row" style="justify-content: right;    margin-bottom: 87px; width: 40%;
    margin-left: 55%;">
      <div class="col">
        <?php echo form_open('alat/search')?>
        <input type="text" style="    width: 74%;" name="keyword" placeholder="Cari...">
    ...
    <div class="col">
        ...
        <div style="    text-align: right;
            margin-right: 3%;">
              <a href="<?php echo base_url()."index.php/alat/tambah"?>" class="btn btn-primary">
      ...
      <div>
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero" style="margin-top: -70px;">
          <!-- Left Column -->
          <div
            class="left-column d-flex flex-column  align-items-center text-center" 
            style="border: 1px solid rgb(252, 252, 252); width: 160px; height: 180px;margin-left: 30px;">
              <img src="<?php echo base_url();?>gambar/<?php echo $item['image']?>" alt="" style="width: 100%; height: 100%;">
          </div>
          <!-- Right Column -->
          <div class="right-column text-center d-flex justify-content-center">
            <table class="table table-alat" style="color: white; text-align: center;margin-left: 30px; border-bottom: hidden;">
              <thead>
                <tr>
                    <th style="width: 16%;">
                    ...
                    <th>
                     ...
                     <a href="<?php echo base_url()."index.php/alat/edit/". $item['id_alat'];?>" class="btn btn-info">
                         <i class="fa fa-pencil-alt"></i>
                     </a>
                     <a onclick="return confirm('Anda yakin mau menghapus artikel ini?')" 
                     href="<?php echo base_url()."index.php/alat/delete/".$item['id_alat'];?>" class="btn btn-danger btn-xs"
                     style="margin-left: 3px; margin-right: 3px;">
                     <i class="fa fa-trash"></i></a>

                       <?php echo form_open_multipart('alat/showId/'.$item['id_alat'], array('method' => 'POST')); ?>    
                           <input type="hidden" value="<?= $item['id_alat']; ?>" name="id_alat" id="id_alat">
