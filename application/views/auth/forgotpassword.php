        ...
        <div class="container header">
            <div class="row">
                <div class="col-lg-6 mt-md-0">
                    ...
                    <?php echo form_open_multipart('auth/forgot', array('method' => 'POST')); ?>    
                        
                    <?php echo $this->session->flashdata('message'); ?>

                            <div class="card">
                                <h1 style="text-align: center; margin-top: -5%;"><b>Change Password?</b> </h1>
                                <div class="input-group mb-4">
                                    <label for="input" class="w-100">
                                        <input id="current_password" type="password" class="form-control mt-2" name="current_password" required autocomplete="email" 
                                ...
                                <div class="input-group mb-4">
                                    <label for="input" class="w-100">
                                        <input id="new_password1" type="password" class="form-control mt-2" name="new_password1" required autocomplete="current-password"
                                ...
                                <div class="input-group mb-4">
                                    <label for="input" class="w-100">
                                        <input id="new_password2" type="password" class="form-control mt-2" name="new_password2" required autocomplete="current-password"
                                        placeholder="Repeat Password">
                                        <!-- <?= form_error('new_password2', '<small class="text-danger pl-3">', '</small>'); ?> -->
                                    </label>
                                </div>

                                <button type="submit" class="btn btn-card">Change Password</button>

                                <p style="margin-top: 18%; text-align: center; color: #000000;">Al Ready Account? 
                                    <a href="<?= base_url()."index.php/auth/login";?>" style="color: #000000;text-decoration: none;">
                                        <b>Sign In</b></a>
                                </p>
