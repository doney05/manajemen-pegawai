        ...
        <div class="container header">
            <div class="row">
                <div class="col-lg-6 mt-md-0">
                    ...
                    <?php echo form_open_multipart('auth/login', array('method' => 'POST')); ?>    
                        
                    <?php echo $this->session->flashdata('message'); ?>

                            <div class="card">
                                <h1 style="text-align: center; margin-top: -5%;"><b>Sign In</b> </h1>
                                <div class="input-group mb-4">
                                    <label for="input" class="w-100">
                                        <input id="email" type="text" class="form-control mt-2" value="<?= set_value('email'); ?>" name="email" required autocomplete="email" 
                                ...
                                <div class="input-group mb-4">
                                    <label for="input" class="w-100">
                                        <input id="password" type="password" class="form-control mt-2" name="password" required autocomplete="current-password"
                                        placeholder="Password">
                                        <?= form_error('password', '<small class="text-danger pl-3">', '</small>'); ?>
                                    </label>
                                </div>
                                <button type="submit" class="btn btn-card">Sign In</button>

                                <p style="margin-top: 18%; text-align: center; color: #000000;">Not registered? 
                                    <a href="<?= base_url()."index.php/auth/register";?>" style="color: #000000;text-decoration: none;">
                                        <b>Sign Up</b></a>
                                </p>
