  ...
  <html lang="en">
    ...
    <div class="container text-center">
      ...
      margin-left: 28%;  ">
        ...
        <?php echo form_open_multipart('material/store', array('method' => 'POST')); ?>    

        <h1 style="color: white; text-align: center">Tambah Material</h1>
              <div class="col-sm-12">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-12">
                      ...
                      id="harga" value="<?= set_value('harga');?>">
                  </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    id="satuan" value="<?= set_value('satuan');?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    id="jumlah" value="<?= set_value('jumlah');?>">
                </div>
            </div>
              </div>
